...
//        assertEquals("Token Generated in headers", result.getBody());
//        assertEquals("testJwtToken", response.getHeader("token"));
//        assertEquals(userName, response.getHeader("userName"));
//    }
//
...
//    }
    ...
    void testLoginUser_ExternalServiceError() {
        ...
        assertEquals("Error calling user service please check the credentials", result.getBody());
    }
}
